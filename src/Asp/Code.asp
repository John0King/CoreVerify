...
VC.BGroundColor = "#FFFFFF" ' 图片背景颜色
VC.FGroundColor = "#000000" ' 前景（文本）颜色
VC.VerifyCode Code, false'False  ' 处理验证码，第二个参数为是否显示彩色文本
VC.Noises 50, true   ' 添加杂点，第一个参数为杂点数量，第二个参数为是否显示彩色杂点
VC.Write      ' 输出图片
